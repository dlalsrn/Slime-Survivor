...
public class PlayerController_Gunner : PlayerController
{
    // Component Variable
    ...
    private float feverShootInterval = 2f; // 공격속도 배수
    ...
    protected override void GetItemCrystal() { // Crystal을 먹었을 경우 일정시간 동안 공격속도 증가
    ...
    protected override void GetItemBook() { // Book을 먹었을 경우 총알 Upgrade
